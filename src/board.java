...
public class board {
	...
	public static void initializeBoard() {
		...
		game[1] = new squareType("KENT", 60, 2, 2, false);
		...
		game[9] = new squareType("PENTION", 120, 8, 10, false);
		game[10] = new squareType("JAIL", 0, 0, 11, true);
		game[11] = new squareType("PALL",140, 10, 12, false);
		...
		game[19] = new squareType("VINE", 200, 16, 20, false);
		game[20] = new squareType("PARKING", 0, 0, 21, true);
		game[21] = new squareType("STRAND", 220, 18, 22, false);
		...
		game[29] = new squareType("PICCAD", 280, 24, 30, false);
		game[30] = new squareType("JAIL", 0, 0, 31, true);
		game[31] = new squareType("REGENT", 300, 26, 32, false);
		...
		game[39] = new squareType("MAYFAIR", 400, 50, 40, false);
